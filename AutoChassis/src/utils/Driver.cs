namespace Utilities
{
    public class Driver
    {
        ...
        public Driver(double helmet_circumference_ = 0, double shoulder_width_ = 0, double upper_arm_length_ = 0, double back_height_ = 0, double head_height_ = 10, double hip_width_ = 16 ) // head_height should default to 0 not 10
        {
